...
import qpsk_sim_with_constModulator_epy_block_1 as epy_block_1  # embedded python block
import qpsk_sim_with_constModulator_epy_block_4 as epy_block_4  # embedded python block
import sip
import threading



class qpsk_sim_with_constModulator(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "qpsk_sim_with_constModulator")
        ...
        self.connect((self.digital_constellation_decoder_cb_0, 0), (self.blocks_uchar_to_float_1, 0))
...
def main(top_block_cls=qpsk_sim_with_constModulator, options=None):
